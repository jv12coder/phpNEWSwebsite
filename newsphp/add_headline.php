...
if (isset($_POST['submit'])) {
	...
	$update_status=$_POST['update'];
	 ...
	 $cheak = mysqli_query($conn,"select * from headlines where headline_data='$headline_data' ");
	...
	$query=mysqli_query($conn,"insert into  headlines(headline_data,update_status)values('$headline_data','$update_status')");
