...
<html lang="en">
  ...
  <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
          <div class="col-1" id="myScrollspy">
              ...
              <div class="headline_content">              
               <ul class="list_item">
                ...
                <div class="overflow-auto p-3 mb-3 mb-md-0 mr-md-3 bg-light" style="max-width: 400px; max-height: 500px;">                
                  ...
                  <?php
                  include('db/connection.php');
                  $query2=mysqli_query($conn,"select * from headlines");
                  while($row=mysqli_fetch_array($query2)){                

                  ?>
                  <li>
                  <blockquote class="blockquote" style="font-size: medium;">
                  <a class="nav-link" href="category_page.php?single=<?php echo$row['headline_data'];  ?>"><?php echo $row['headline_data']; ?> </a>
                  <footer class="blockquote-footer"><?php echo $row['update_status']; ?></footer>
                  </blockquote>
                  </li>
                  <?php } ?>
